...
console.log(h)
// console.log(h[0])
// console.log(h[0].jobTitle)
// console.log(h[0].benefits)
// console.log('- first job hit benifit')
// for(let i = 0 ; i<h[0].benefits.length ; i++){
//   console.log(h[0].benefits[i].benefitValue)
// }
// cau7
// for(let i = 0; i<h.length;i++){
//   console.log(h[i].jobTitle);
//   console.log('-benefits')
//   for(let j = 0 ; j < h[i].benefits.length; j++){
//     console.log(h[i].benefits[j].benefitValue);  
//   }
//   console.log('-----------------------')
// }
// cau8
for(let i = 0; i<h.length;i++){
  console.log('Title : '+ h[i].jobTitle);
  console.log('Salary : '+ h[i].jobSalary);
  ...
  console.log('Skills : \n')
  for(let j = 0 ; j <h[i].skills.length ; j++){
    console.log('- '+h[i].skills[j])
  }
  console.log('-----------------------')
}