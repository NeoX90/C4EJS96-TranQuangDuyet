...
console.log("+ you can't use any other characters, including spaces (khoa?ng trang), symbols and punctuation marks(da'u ca^u)")
console.log("+ you can't use one of JavaScript's reserved words (key words) as a variable name")
